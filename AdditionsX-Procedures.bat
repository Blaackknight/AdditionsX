...
if "%o%"=="1" (
    ...
    if /i "%user_input%"=="Yes" (
        ...
        curl --progress-bar https://raw.githubusercontent.com/Blaackknight/AdditionsX/main/GenericFortune.ptpl -o "C:\Users\lolmd\.mcreator\templates\ptpl\GenericFortune.ptpl" && echo "\-> GENERICFORTUNE.PTPL Downloaded."
        color 0A
        timeout /T 1 >nul
        color 0C
        curl --progress-bar https://raw.githubusercontent.com/Blaackknight/AdditionsX/main/GolemSpawnProcedure.ptpl -o "C:\Users\lolmd\.mcreator\templates\ptpl\GolemSpawnProcedure.ptpl" && echo "\-> GOLEMSPAWNPROCEDURE.PTPL Downloaded."
        color 0A
        timeout /T 1 >nul
        color 0C
